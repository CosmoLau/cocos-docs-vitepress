...
To use `EditBox`, please refer to the [EditBox API](__APIDOC__/en/class/EditBox) documentation and the [EditBox](https://github.com/cocos/cocos-test-projects/tree/v3.8/assets/cases/ui/12.editbox) scene of the test-cases-3d project.
